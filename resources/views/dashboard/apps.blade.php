      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">{{ __('Applications') }}</span>
          </div>
        </li>
      </ol>
    </nav>
    <h1 class="mb-4 sm:mb-0 text-xl font-semibold text-gray-900 dark:text-white">{{ __('Applications') }}</h1>
  </div>
  <button
